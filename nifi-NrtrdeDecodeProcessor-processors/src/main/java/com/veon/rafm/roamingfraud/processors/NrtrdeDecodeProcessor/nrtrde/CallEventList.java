...
public class CallEventList implements Serializable {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.APPLICATION_CLASS, BerTag.CONSTRUCTED, 2);
	public byte[] code = null;
	private List<CallEvent> seqOf = null;

	public CallEventList() {
		seqOf = new ArrayList<CallEvent>();
	}

	public CallEventList(byte[] code) {
		this.code = code;
	}

	public List<CallEvent> getCallEvent() {
		if (seqOf == null) {
			seqOf = new ArrayList<CallEvent>();
		}
		return seqOf;
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		while (subCodeLength < totalLength) {
			CallEvent element = new CallEvent();
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (seqOf == null) {
			...
			Iterator<CallEvent> it = seqOf.iterator();
			if (it.hasNext()) {
