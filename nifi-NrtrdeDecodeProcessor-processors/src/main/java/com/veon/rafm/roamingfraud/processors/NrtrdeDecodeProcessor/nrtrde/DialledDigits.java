...
public class DialledDigits extends AsciiString {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.APPLICATION_CLASS, BerTag.PRIMITIVE, 30);

	public DialledDigits() {
	}

	public DialledDigits(byte[] value) {
		super(value);
	}
