...
public class Moc implements Serializable {
	...
	private SupplementaryServiceCode supplementaryServiceCode = null;
	...
	public void setSupplementaryServiceCode(SupplementaryServiceCode supplementaryServiceCode) {
		this.supplementaryServiceCode = supplementaryServiceCode;
	}
	@JsonSerialize(using= ByteArraySerializer.class)
	public SupplementaryServiceCode getSupplementaryServiceCode() {
	...
	public int encode(BerByteArrayOutputStream os, boolean withTag) throws IOException {
		...
		if (thirdPartyNumber != null) {
			codeLength += thirdPartyNumber.encode(os, true);
		}
		
		if (connectedNumber != null) {
			codeLength += connectedNumber.encode(os, true);
		}
		
		if (dialledDigits != null) {
			codeLength += dialledDigits.encode(os, true);
		}
		
		if (supplementaryServiceCode != null) {
			codeLength += supplementaryServiceCode.encode(os, true);
		}
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(SupplementaryServiceCode.tag)) {
			supplementaryServiceCode = new SupplementaryServiceCode();
			subCodeLength += supplementaryServiceCode.decode(is, false);
			if (subCodeLength == totalLength) {
				return codeLength;
			}
			subCodeLength += berTag.decode(is);
		...
		if (berTag.equals(ConnectedNumber.tag)) {
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (supplementaryServiceCode != null) {
			...
			sb.append("supplementaryServiceCode: ").append(supplementaryServiceCode);
			firstSelectedElement = false;
		}
