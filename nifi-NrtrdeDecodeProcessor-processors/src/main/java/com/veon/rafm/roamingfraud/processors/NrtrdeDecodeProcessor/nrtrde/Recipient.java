...
public class Recipient extends AsciiString {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.APPLICATION_CLASS, BerTag.PRIMITIVE, 36);

	public Recipient() {
	}

	public Recipient(byte[] value) {
		super(value);
	}
