...
public class ServingNetwork extends AsciiString {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.APPLICATION_CLASS, BerTag.PRIMITIVE, 15);

	public ServingNetwork() {
	}

	public ServingNetwork(byte[] value) {
		super(value);
	}
