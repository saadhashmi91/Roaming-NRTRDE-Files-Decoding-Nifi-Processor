...
public class SgsnAddress extends AsciiString {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.APPLICATION_CLASS, BerTag.PRIMITIVE, 40);

	public SgsnAddress() {
	}

	public SgsnAddress(byte[] value) {
		super(value);
	}
