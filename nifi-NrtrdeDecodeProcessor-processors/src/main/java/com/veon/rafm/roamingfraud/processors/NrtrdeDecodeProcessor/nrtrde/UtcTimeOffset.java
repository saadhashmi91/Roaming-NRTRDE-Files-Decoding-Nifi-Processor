...
public class UtcTimeOffset extends AsciiString {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.APPLICATION_CLASS, BerTag.PRIMITIVE, 45);

	public UtcTimeOffset() {
	}

	public UtcTimeOffset(byte[] value) {
		super(value);
	}
